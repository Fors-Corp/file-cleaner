"""FROZEN REFERENCE — ``safety.py`` exactly as shipped in 1.3.0. NOT USED BY
FILE CLEANER. It contains a known hole (case- and normalisation-sensitive
comparisons) and exists only as the "before" side of
``tools/safety_differential.py``. Do not import it from ``src/``.
